...
mod tests {
    ...
    fn absolute_path_inside_workspace_allowed_when_workspace_only() {
        let p = SecurityPolicy {
            workspace_dir: PathBuf::from("/home/user/.miroclaw/workspace"),
            workspace_only: true,
            ..SecurityPolicy::default()
        };
        // Absolute path inside workspace should be allowed
        assert!(p.is_path_allowed("/home/user/.miroclaw/workspace/images/example.png"));
        assert!(p.is_path_allowed("/home/user/.miroclaw/workspace/file.txt"));
    ...
    fn absolute_path_in_allowed_root_permitted_when_workspace_only() {
        let p = SecurityPolicy {
            workspace_dir: PathBuf::from("/home/user/.miroclaw/workspace"),
            workspace_only: true,
            allowed_roots: vec![PathBuf::from("/home/user/.miroclaw/shared")],
            ..SecurityPolicy::default()
        };
        // Path in allowed root should be permitted
        assert!(p.is_path_allowed("/home/user/.miroclaw/shared/data.txt"));
