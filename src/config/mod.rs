...
pub use schema::{
    ...
    PacingConfig, PeripheralBoardConfig, PeripheralsConfig, PiperTtsConfig, PlannerConfig,
    PlannerTriggerMode, PluginsConfig, ProjectIntelConfig, ProxyConfig, ProxyScope, QdrantConfig,
