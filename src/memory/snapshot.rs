...
const SNAPSHOT_HEADER: &str = "# 🧠 MiroClaw Memory Snapshot\n\n\
    > Auto-generated by MiroClaw. Do not edit manually unless you know what you're doing.\n\
...
mod tests {
    ...
    fn parse_snapshot_basic() {
        let input = r#"# 🧠 MiroClaw Memory Snapshot

> Auto-generated by MiroClaw.
...
I am MiroClaw, a self-preserving AI agent.
...
"#;
    ...
    fn parse_snapshot_empty() {
        let input = "# 🧠 MiroClaw Memory Snapshot\n\n> Nothing here.\n";
        let entries = parse_snapshot(input);
