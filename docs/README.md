...
| In-chat slash commands (`/new`, `/models`, gateway `/read`, …) + optional Telegram `/z` hub | [telegram-slash-commands.md](setup-guides/telegram-slash-commands.md) |
