# Miroclaw Trademark Policy

**Effective date:** February 2026  
**Maintained by:** Miroclaw Labs

---

## Our Trademarks

The following are trademarks of Miroclaw Labs:

- **Miroclaw** (word mark)
- **morpheum-labs** (organization name on GitHub)
- The Miroclaw logo and associated visual identity

These marks identify the official Miroclaw project and distinguish it from
...
The **only** official Miroclaw repository is:

> https://github.com/morpheum-labs/miroclaw

Any other repository, organization, domain, or product claiming to be
"Miroclaw" or implying affiliation with Miroclaw Labs is unauthorized and
may constitute trademark infringement.

**Known unauthorized forks:**
- `openagen/zeroclaw` — not affiliated with Miroclaw Labs

If you encounter an unauthorized use, please report it by opening an issue
at https://github.com/morpheum-labs/miroclaw/issues.

---

## Permitted Uses

You **may** use the Miroclaw name and marks in the following ways without
prior written permission:

1. **Attribution** — stating that your software is based on or derived from
   Miroclaw, provided it is clear your project is not the official Miroclaw.

2. **Descriptive reference** — referring to Miroclaw in documentation,
...
4. **Fork identification** — identifying your fork as "a fork of Miroclaw"
...
You **may not** use the Miroclaw name or marks in ways that:

1. **Imply official endorsement** — suggest your project, product, or
   organization is officially affiliated with or endorsed by Miroclaw Labs.

2. **Cause brand confusion** — use "Miroclaw" as the primary name of a
...
3. **Impersonate the project** — create repositories, domains, packages,
   or accounts that could be mistaken for the official Miroclaw project.

4. **Misrepresent origin** — remove or obscure attribution to Miroclaw Labs
   while distributing the software or derivatives.

5. **Commercial trademark use** — use the marks in commercial products,
   services, or marketing without prior written permission from Miroclaw Labs.
...
you fork Miroclaw, you must:

- Clearly state your project is a fork of Miroclaw
- Link back to the official repository
- Not use "Miroclaw" as the primary name of your fork
...
Contributors to the official Miroclaw repository are protected under the
...
If you believe someone is infringing Miroclaw trademarks:

1. Open an issue at https://github.com/morpheum-labs/miroclaw/issues
...
Miroclaw Labs reserves the right to update this policy at any time. Changes
...
this policy governs use of the Miroclaw name and brand.*
