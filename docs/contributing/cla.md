# Miroclaw Contributor License Agreement (CLA)
...
property rights granted by contributors to Miroclaw Labs. This agreement
protects both contributors and users of the Miroclaw project.

By submitting a contribution (pull request, patch, issue with code, or any
other form of code submission) to the Miroclaw repository, you agree to the
terms of this CLA.
...
- **"Contribution"** means any original work of authorship, including any
  modifications or additions to existing work, submitted to Miroclaw Labs
  for inclusion in the Miroclaw project.

- **"You"** means the individual or legal entity submitting a Contribution.

- **"Miroclaw Labs"** means the maintainers and organization responsible
  for the Miroclaw project at https://github.com/morpheum-labs/miroclaw.

---

## 2. Grant of Copyright License

You grant Miroclaw Labs and recipients of software distributed by Miroclaw Labs a perpetual, worldwide, non-exclusive, no-charge, royalty-free,
...
the Miroclaw project.

**This protects you:** if a third party files a patent claim against
Miroclaw that covers your Contribution, your patent license to the project
is not revoked.
...
This CLA does **not** transfer ownership of your Contribution to Miroclaw Labs. You retain full copyright ownership of your Contribution. You are
...
3. If your employer has rights to intellectual property you create, you
   ...
   has signed a corporate CLA with Miroclaw Labs.

---

## 6. No Trademark Rights

This CLA does not grant you any rights to use the Miroclaw name,
...
Miroclaw Labs will maintain attribution to contributors in the repository
...
All Contributions accepted into the Miroclaw project are licensed under
both:
...
By opening a pull request or submitting a patch to the Miroclaw repository,
...
https://github.com/morpheum-labs/miroclaw/issues

---

*This CLA is based on the Apache Individual Contributor License Agreement
v2.0, adapted for the Miroclaw dual-license model.*
